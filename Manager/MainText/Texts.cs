...
namespace com.Keys.SetKey.Manager
{
    ...
    {
        public abstract String[] Alphabets { get; set; }

        public abstract String[] GenerateALphabets { get; set; }
    }
}
/*
  public String[] GenerateALphabets = new String[]
        {
        ...
        public String[] Alphabets = new String[]
        {
